...
class _FixDishActState extends State<FixDishAct> {
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(Icons.soup_kitchen, color: Colors.green),
                                  ),
                                  validator: (value) {
                                    return null;
                                  },
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        ...
                                        maxLines: 1,
                                        style: TextStyle(color: Colors.black, fontSize: 21, fontFamily: "SVN_Comic", fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                   Padding(
                                        ...
                                        child: TextButton.icon(
                                          onPressed: () async {
                                            final result = await Navigator.push<BasicIngredient>(
                                              context,
                                              MaterialPageRoute(builder: (context) => ChooseFoodAct()),
                                            );

                                            if (result != null) {
                                              setState(() {
                                                final index = ingredients.indexWhere((f) => f.ingredientId == result.ingredientId);
                                                if (index == -1) {
                                          ...
                                          label: Text(
                                            ...
                                            maxLines: 2,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(fontSize: 16, fontFamily: "SVN_Comic"),
                                          ),
                                        ),
                                      ),
                                  ],
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return ItemWeightFood(
                                      ...
                                      onRemove: () {
                                        setState(() {
                                          ingredients.removeWhere((f) => f.ingredientId == ingredient.ingredientId);
                                        });
                                      },
                                    );
                                  },
                                    ...
                                    children:
                                        selectedHashtags.map((tag) {
                                          return Container(
                                            ...
                                            child: Text(tag.title, style: const TextStyle(fontSize: 13, fontFamily: 'Nunito', color: Colors.black87)),
                                          );
                                        }).toList(),
                                  ),
                                SizedBox(height: 15),
  ...
  Future<bool> _fixDish(
    ...
    List<IngredientItem> ingredientItems = ingredients.map((ing) => IngredientItem(ingredientId: ing.ingredientId, weight: ing.weight)).toList();
