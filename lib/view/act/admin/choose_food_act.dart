...
import 'package:al_datn_my_health/view/custom_view/item_add_food.dart';
import 'package:al_datn_my_health/view/custom_view/item_suggestion.dart';
import 'package:flutter/material.dart';

import '../../../api/sever_api.dart';

class ChooseFoodAct extends StatefulWidget {
  @override
  _ChooseFoodActState createState() => _ChooseFoodActState();
}

class _ChooseFoodActState extends State<ChooseFoodAct> {
  int _page = 1;
  final int _limit = 15;
  bool isLoading = true;
                            ...
                            : NotificationListener<ScrollNotification>(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ItemAddFood(infoFood: food);
                                },
                              ),
                            ),
                  ),
