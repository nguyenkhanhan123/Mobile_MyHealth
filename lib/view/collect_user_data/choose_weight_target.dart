import 'package:al_datn_my_health/view/collect_user_data/choose_activity_level.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.all(15),
                    child: Text(
                      'Chỉ số khối cơ thể (BMI) của bạn lúc đó sẽ là',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 16,
                  ...
                  Container(
                    margin: EdgeInsets.all(15),
                    child: Text(
                      'Lúc đó chỉ số BMI của bạn đang ở mức',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 16,
