...
class ChooseHeight extends StatefulWidget {
  ...
  const ChooseHeight({super.key, required this.userInfo});
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Expanded(flex: 1, child: Image.asset('assets/images/ic_height.png')),
          Container(
                ...
                onPressed: () {
                  if(_heightController.text.trim().isNotEmpty){
                    ...
                    if(height!=null){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ChooseWeight(userInfo: widget.userInfo)),
                      );
                    }else{
